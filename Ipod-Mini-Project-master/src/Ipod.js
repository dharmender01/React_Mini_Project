                ...
                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.menuButton}>
                            ...
                            <p onClick={this.changePageToHomeScreen} style={{fontSize:"25px" , color:"white", cursor:"pointer"}} >Menu</p>
                        </div>
                    ...
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.middleButtons}>
                            ...
                            <div onClick={this.changePage} style={{backgroundImage: 'linear-gradient(45deg, rgb(200 205 20), transparent)' , width : '5rem' , height : '5rem' , borderRadius : '50%'}}></div>
...
const styles = {
    ipodContainer : {
        height : '33rem',
        width : '20rem',
        backgroundImage: 'radial-gradient(rgb(20 118 217), rgb(16 81 114))',
        margin : '4rem auto',
        display : 'flex',
        flexDirection : 'row',
        flexWrap : 'wrap',
